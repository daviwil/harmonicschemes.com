;;; publish.el --- Build harmonicschemes.com
...
;; URL: https://github.com/daviwil/harmonicschemes.com
;; Version: 0.0.1
...
;; Usage:
;; emacs --batch -l ~/Projects/Writing/Blog/publish.el --funcall dw/publish
...
(setq dw/site-title   "Harmonic Schemes")
(setq dw/site-tagline "by David Wilson")
                           ...
                           (div (@ (class "col-sm-4 col-md-4 nav-icons"))
                                (div (@ (class "text-sm-left text-md-right text-lg-right text-xl-right"))
                                     (a (@ (class "nav-link nav-icon")
                                           (href "https://soundcloud.com/daviwil")
                                           (target "_blank"))
                                     ...
                                     (a (@ (class "nav-link nav-icon")
                                           (href "https://twitter.com/daviwil")
                                           (target "_blank"))
                                        (i (@ (class "fa fa-twitter fa-lg")) ""))
                                     (a (@ (class "nav-link nav-icon")
                                           (href "https://harmonicschemes.com/rss.xml")
                                           (target "_blank"))
   ...
   (sxml-to-xml
    `(footer (@ (class "blog-footer"))
      (div (@ (class "container"))
           (div (@ (class "row"))
                (div (@ (class "col-sm-12 col-md-8"))
                     "<p xmlns:dct=\"http://purl.org/dc/terms/\" xmlns:cc=\"http://creativecommons.org/ns#\" class=\"license-text\"><a rel=\"cc:attributionURL\" href=\"https://harmonicschemes.com\"><span rel=\"dct:title\">Harmonic Schemes</span></a> by <a rel=\"cc:attributionURL\" href=\"https://daviwil.com\"><span rel=\"cc:attributionName\">David Wilson</span></a> is licensed under <a href=\"https://creativecommons.org/licenses/by-sa/4.0\">CC BY-SA 4.0</a></p>")
  ...
  (concat
   ...
   (sxml-to-xml
    ...
    <link href=\"https://fonts.googleapis.com/css?family=recentCabin|PT+Sans|Source+Sans+Pro\" rel=\"stylesheet\">"
             (title ,(concat (org-export-data (plist-get info :title) info) " - Harmonic Schemes")))
           (body
             ,(dw/site-header info)
             (div (@ (class "container"))
                  (div (@ (class "row"))
...
(defun dw/make-site-section (title path-name &optional sitemap?)
  (list (concat "harmonicschemes.com:" path-name)
        :recursive t
...
(setq org-publish-project-alist
      (list
       (dw/make-site-section "Articles" "articles" t)
       (list "harmonicschemes.com:main"
             :recursive t
             :base-directory "./"
             :publishing-function '(org-html-publish-to-html)
             :publishing-directory "./docs/"
             :with-title nil)
       (list "harmonicschemes.com:static"
             ...
             :recursive t)
       (list "site" :components '("harmonicschemes.com:main"
                                  "harmonicschemes.com:articles"))))

(defun dw/publish ()
  (interactive)
  (org-publish-all t)
  (setq webfeeder-default-author "David Wilson <david@daviwil.com>")
  (pp
  ...
  (webfeeder-build
   "rss.xml"
   "./docs/"
   "https://harmonicschemes.com/"
   (delete "articles/index.html"
           (mapcar (lambda (f) (replace-regexp-in-string ".*/docs/" "" f))
                   (directory-files-recursively "docs/articles" "index.html")))
   :builder 'webfeeder-make-rss
   :title "Harmonic Schemes"
   :description "The project log of David Wilson"
   :max-entries 20))
